  ...
  filesUploader = files => {
    ...
    for (let i = 0; i < files.length; i++) {
      if (files[i].size > maxSize || files[i].size < minSize) {
        const error =
          "Please pick the files what sizes are between 50000 byte and 4000000 byte\n";
        console.log(error);
        return;
      }
    }
    ...
    return (
      <Container>
        ...
        <Row>
          <Col sm={3}>
            ...
            <input
              ...
              onChange={e => {
                this.setCrop({ width: e.currentTarget.value - 0 });
              }}
            />
          </Col>
          <Col sm={3}>
            ...
            <input
              ...
              onChange={e => {
                this.setCrop({ height: e.currentTarget.value - 0 });
              }}
            />
          </Col>
          <Col sm={6}>
        ...
        <Row>
          <img
            id="overlay"
            src={croppedImages.length ? croppedImages[currentFileIndex] : null}
          />
        </Row>
